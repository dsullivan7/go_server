...
func (c *Controllers) ListPortfolioRecommendations(w http.ResponseWriter, r *http.Request) {
	...
	portfolioHoldings := c.services.ListPortfolioRecommendations(*portfolio, portfolioTags, securities, securityTags)
